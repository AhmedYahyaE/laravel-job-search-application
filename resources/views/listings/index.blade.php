...
<x-layout> {{-- For using 'layout.blade.php' as a Blade Component, check 1:46:43 in https://www.youtube.com/watch?v=MYyJ4PuL4pY --}}
    ...
    {{-- @section('content') --}}
        ...
        <div class="lg:grid lg:grid-cols-2 gap-4 space-y-4 md:space-y-0 mx-4">
            ...
            @unless (count($listings) == 0) {{-- @unless is like    @if NOT    --}} {{-- @unless Blade Directive: https://laravel.com/docs/9.x/blade#components:~:text=also%20provides%20an-,%40unless,directive,-%3A --}}
