        ...
        <form method="POST" action="/users">  {{-- this will hit the post() method of the /users route to hit the store() method in UserController.php --}}
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    name="name"
                    value="{{ old('name') }}" {{-- Repopulating Forms: https://laravel.com/docs/9.x/validation#repopulating-forms --}}
                />
            ...
            <div class="mb-6">
                ...
                <input
                    type="password"
                    class="border border-gray-200 rounded p-2 w-full"
                    name="password_confirmation" {{-- Note: You must stick to that 'x_confirmation' naming convention in order for the validation rule to work! Check the store() method in UserController! For Password and Password Confirmation validation rules, check 'confirmed': https://laravel.com/docs/9.x/validation#rule-confirmed     AND     check 3:23:54 in https://www.youtube.com/watch?v=MYyJ4PuL4pY --}}
                    value="{{ old('password_confirmation') }}" {{-- Repopulating Forms: https://laravel.com/docs/9.x/validation#repopulating-forms --}}
                />
